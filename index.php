...
<html lang="en">
<head>
  <title>WELCOME - HOTEL TOKYO</title>
  <meta charset="utf-8">
...
<div class="p-2 bg-secondary text-white text-center">
  <h1>HOTEL TOKYO</h1>
  <p>Selamat datang di Hotel Tokyo Jember Indonesia!</p> 
</div>
<!------------------AKHIR BAGIAN HEADER----------------- -->
...
<nav class="navbar navbar-expand-sm navbar-dark bg-info">
      <div class="container-fluid">
        <a class="navbar-brand" href="#">@HOTELTOKYO</a>
...
<div class="container mt-2" id="panel_fasilitas_kami">
    ...
    <h2 class="text-center" >FASILITAS UMUM</h2>
      <h5 class="text-center">Hotel Tokyo</h5>
  ...
  <div class="d-flex justify-content-center">
    <div class="row">
     <div class="col-sm-12 p-5">
      ...
      <p> <b>Hotel Tokyo</b> Terletak di jl. Mataram di pusat kota Jember. Menyediakan kamar ber-AC dengan WIFI gratis. Akomodasi ini memiliki sebuah kolam renang luar ruangan, serta restoran yang berada di rooftop. 
    </p>
   </div>
  </div>
