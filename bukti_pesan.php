...
<html lang="en">
<head>
  <title><?php echo "Tokyo Hotel - ".$nama; ?></title>
  <meta charset="utf-8">
...
<div id="invoice">
    ...
    <div class="invoice overflow-auto">
        <div style="min-width: 600px">
            <header>
                <div class="row">
                    ...
                    <div class="col company-details">
                        ...
                        <div>Jember,Jatim </div>
                        <div>(123) 456-789</div>
                        <div>tokyohotel@gmail.com</div>
                    </div>
                </div>
            </header>
            <main>
                <div class="row contacts">
                    <div class="col invoice-to">
                        ...
                        <div class="address">Jember, Jatim, Indonesia</div>
            ...
            <footer>
                Bukti pemesanan kamar Hotel Tokyo- Jember - Jatim - Indonesia.
            </footer>
        </div>
